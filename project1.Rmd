...
## Normality with Shapiro Wilks test
```{r}
...
TODO:
- create binned temperature and binned precip vars
  - TMAX: 
  - PCRP: 
- for each route, permute durations within group of member, day of week, binned temp, binned precip
  - make sure to print size of each group: if only one or few obs of a specific, cut at higher than 100
- if computationally suck, identify routes that show increase or decrease
