...
routes <- data_weather[data_weather$n > 100,][,c('station_start', 'station_end')] %>% distinct()
...
```{r}
# get geographical data (lat & long) regarding stations
...
#take those with matching terminalNames
